module.exports = {
	...
	expressServer: {
		enabled: true, // whether the express server is enabled or not
		secret: "XXXXXXXXXXX", // Your discord client secret
		port: 8080, // Express server port
		expressSessionPassword: "put-what-you-want-here", // Express session password (it can be what you want)
		dashboard: {
